...
class UjianModel extends Model
{
    ...
    protected $allowedFields    = ['id_siswa','kode_ujian', 'nama_ujian', 'guru', 'kelas', 'mapel', 'date_created', 'waktu_mulai', 'waktu_berakhir','start_ujian', 'end_ujian', 'jenis_ujian','status','nilai','kuota','verifikasi','updated_at'];
