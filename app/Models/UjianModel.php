...
class UjianModel extends Model
{
    ...
    protected $allowedFields    = ['id_siswa','kode_ujian', 'nama_ujian', 'guru', 'kelas', 'mapel', 'jml_mudah', 'jml_sedang', 'jml_susah', 'waktu_per_soal', 'date_created', 'waktu_mulai', 'waktu_berakhir','start_ujian', 'end_ujian', 'jenis_ujian','status','nilai','kuota','verifikasi','updated_at'];
