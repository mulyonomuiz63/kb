...
class IkhModel extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'pendidikan_terakhir','jurusan','tahun_masuk', 'tahun_lulus', 'no_wa', 'email', 'email_custom','kategori_kantor', 'nama_kantor', 
        'alamat_ktp', 'alamat_korespondensi', 'riwayat_pekerjaan','is_riwayat_hidup', 'is_bukan_pns', 'is_pakta_integritas', 
