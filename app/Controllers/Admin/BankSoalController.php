...
class BankSoalController extends BaseController
{
    ...
    public function create()
    {
        $data['breadcrumbs'] = [
            ['title' => 'Dashboard', 'url' => base_url('sw-admin')],
            ['title' => 'Bank Soal', 'url' => base_url('sw-admin/bank-soal')],
            ['title' => 'Tambah Soal', 'url' => '#'],
        ];
        $data['kategori'] = $this->kategoriModel->getAll();
        return view('admin/bank_soal/tambah_pg', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('sw-admin/bank-soal')->with('success', 'Soal berhasil dibuat.');
    }
    ...
    public function edit($id_bank_soal)
    {
        ...
        return view('admin/bank_soal/edit_pg', $data);
    }
    ...
    public function update()
    {
        ...
        return redirect()->to('sw-admin/bank-soal')->with('success', 'Soal berhasil diubah');
    }
    ...
    public function delete($id_bank_soal)
    {
        ...
        return redirect()->to('sw-admin/bank-soal')->with('success', 'Soal berhasil dihapus');
    }
