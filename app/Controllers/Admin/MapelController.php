...
class MapelController extends BaseController
{
    ...
    public function datatables()
    {
        ...
        // 1. Ambil instance Query Builder resmi dari Model
        $builder = $this->mapelModel->builder();

        // 2. Filter data yang belum dihapus (Soft Delete)
        ...
        // 4. Hitung filtered data menggunakan CLONE agar state builder utama tidak rusak
        $countBuilder  = clone $builder;
        $totalFiltered = $countBuilder->countAllResults();

        // 5. Eksekusi query utama dengan limit & offset
        ...
        foreach ($data as $row) {
            ...
            $encryptedId = encrypt_url($row->id_mapel);
        ...
        <div class="dropdown text-center">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                <li>
                    <a class="dropdown-item py-2 edit-mapel" href="javascript:void(0)" data-id="' . $encryptedId . '">
                        <i class="ki-duotone ki-pencil text-primary me-2"><span class="path1"></span><span class="path2"></span></i> Edit
                    </a>
                </li>
                <li>
                    <a class="dropdown-item py-2 text-danger btn-delete" href="javascript:void(0)" data-url="' . base_url('sw-admin/mapel/delete/' . $encryptedId) . '">
                        <i class="ki-duotone ki-trash text-danger me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> Hapus
                    </a>
                </li>
            </ul>
        </div>';
            ...
            $result[] = [
                ...
                '<img src="' . $imgUrl . '" class="rounded border shadow-sm" style="max-width:80px; height:auto; object-fit:cover;">',
                $opsi
            ];
        }
        ...
        return $this->response->setJSON([
            ...
            "recordsTotal"    => $this->mapelModel->where('deleted_at', null)->countAllResults(),
    ...
    public function delete($id = null)
    {
        ...
        try {
            ...
            // 3. Eksekusi Soft Delete (Hanya update kolom deleted_at)
