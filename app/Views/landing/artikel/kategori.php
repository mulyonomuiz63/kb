        ...
        <div class="row">
            <div class="col-12 col-md-8 mb-8">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="row ">
                            <?php foreach ($dataPagination as $rows): ?>
                                <div class="col-12 col-md-6 mt-4 card-artikel">
                                    <div class="img-artikel position-relative">
                                        <?= img_lazy('uploads/artikel/thumbnails/'.$rows['image_default'],"loading", ['class' => 'zoom', 'height'=>'240px']) ?>
