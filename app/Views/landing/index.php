                    ...
                    <div class="modal-dialog modal-sm modal-dialog-centered"  id="modalIklan">
                      <div class="modal-content ">
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                          ...
                          <div class="carousel-inner">
                            <?php $no=0; foreach ($dataIklan as $rows) : $no++ ?>
        ...
        <div class="modal-dialog modal-xl" >
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <iframe src="https://docs.google.com/gview?embedded=true&url=<?= urlencode(base_url("assets-landing/images/surat-izin/izin-LKP-akuntanmu-01.pdf")) ?>" width="100%" height="500px"></iframe>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl" >
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <iframe src="https://docs.google.com/gview?embedded=true&url=<?= urlencode(base_url("assets-landing/images/surat-izin/izin-LPK-akuntanmu-01.pdf")) ?>" width="100%" height="500px"></iframe>
            </div>
        </div>
    </div>
