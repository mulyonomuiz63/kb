...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=4623821844565938&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="mobile-bottom-nav">
            ...
            <!-- Menu Tentang Kami -->
            <a href="<?= base_url('tentangkami'); ?>" class="mobile-bottom-nav-item">
                <i class="bi bi-info-circle"></i>
                <span>Tentang</span>
            </a>

            <!-- Menu Pelatihan -->
            <a href="<?= base_url('pelatihan'); ?>" class="mobile-bottom-nav-item">
                <i class="bi bi-mortarboard"></i>
                <span>Pelatihan</span>
            </a>

            <!-- Menu Penilaian -->
            <a href="<?= base_url('penilaian'); ?>" class="mobile-bottom-nav-item">
                            ...
                            <div class="mt-2 mb-2">
                                <div class="mt-2 mb-2">
                                    <div class="row g-2 g-md-3">
                                        ...
                                        <div class="col-6">
                                            <a href="https://topcs.id/kelas-brevet" class="badge p-3 p-md-3 rounded-pill  btn-hover-dark text-nowrap w-100 text-center d-block" style="background-color: #25D366; font-size: clamp(9px, 2.8vw, 10px);">
                                                KONSULTASI SEKARANG
                                            </a>
                                        </div>
                                    </div>
