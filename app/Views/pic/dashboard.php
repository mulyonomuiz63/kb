        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-lg-4 layout-spacing">
                <div class="widget widget-five infobox-3" style="width: 100%; padding: 10px;">
                    ...
                    <h5 class="info-heading mt-4 text-center">Jumlah Data Pengajar</h5>
                    <div class="widget-content">
                        <div class="w-content" style="padding: 0;">
                            <div class="">
                                <p class="task-left"><?= count($guru); ?></p>
                                <p class="task-completed"><span><?= count($guru_aktif); ?> Pengajar</span> Aktif</p>
                                <p class="task-hight-priority"><span><?= count($guru_tidak_aktif); ?> Pengajar</span> Tidak Aktif</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row layout-top-spacing">
            <div class="col-lg-4 layout-spacing">
                <div class="widget widget-five infobox-3" style="width: 100%; padding: 10px;">
                    ...
                    <h5 class="info-heading mt-4 text-center">Jumlah Mitra</h5>
                    <div class="widget-content">
                        <div class="w-content" style="padding: 0;">
                            <div class="">
                                <p class="task-left"><?= count($mitra); ?></p>
                                <p class="task-completed"><span><?= count($mitra); ?> Mitra</span> Aktif</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 layout-spacing">
                <div class="widget widget-five infobox-3" style="width: 100%; padding: 10px;">
                    ...
                    <h5 class="info-heading mt-4 text-center">Jumlah Peserta Lulus</h5>
                    <div class="widget-content">
                        <div class="w-content" style="padding: 0;">
                            <div class="">
                                <p class="task-left"><?= $peserta_lulus; ?></p>
                                <p class="task-completed"><span><?= $peserta_lulus; ?> Peserta</span> Lulus</p>
                            </div>
                        </div>
                    </div>
                </div>
