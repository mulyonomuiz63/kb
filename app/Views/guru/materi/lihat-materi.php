...
<script>
    ...
    function loadChatMateri(kode, idguru) {
        if (!kode) return;
        $.post(baseUrl + "sw-guru/materi/get-chat-materi", { kode_materi: kode, idguru: idguru }, function(html) {
    ...
    function loadFileMateri(kode) {
        if (!kode) return;
        $.post(baseUrl + "sw-guru/materi/get-file-materi", { kode_materi: kode }, function(res) {
