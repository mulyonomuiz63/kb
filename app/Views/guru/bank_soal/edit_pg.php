                        ...
                        <div id="soal_pg">
                            <div class="isi_soal">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="nama_soal" cols="30" rows="2" class="summernote" wrap="hard" required><?= $soal->nama_soal; ?></textarea>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_1" value="<?= $soal->pg_1; ?>" class="form-control" placeholder="Opsi A" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_2" value="<?= $soal->pg_2; ?>" class="form-control" placeholder="Opsi B" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_3" value="<?= $soal->pg_3; ?>" class="form-control" placeholder="Opsi C" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_4" value="<?= $soal->pg_4; ?>" class="form-control" placeholder="Opsi D" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_5" value="<?= $soal->pg_5; ?>" class="form-control" placeholder="Opsi E" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="jawaban" value="<?= $soal->jawaban; ?>" class="form-control" placeholder="Contoh : A" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="penjelasan" cols="30" rows="2" class="summernote" wrap="hard" required><?= $soal->penjelasan; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
