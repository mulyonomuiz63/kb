                    ...
                    <div class="card-body pt-15">
                        <div class="d-flex flex-center flex-column mb-5">
                            <div class="symbol symbol-100px symbol-circle mb-7 shadow">
                                <img src="<?= base_url('assets/app-assets/user/') . '/' . $guru->avatar; ?>" alt="image" style="object-fit: cover;" />
                            </div>
                            
                            <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"><?= $guru->nama_guru; ?></a>
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">
                                    <a href="mailto:<?= $guru->email; ?>" class="text-gray-600 text-hover-primary"><?= $guru->email; ?></a>
                                </div>

                                <div class="fw-bold mt-5 text-gray-800">Bergabung Sejak</div>
                                <div class="text-gray-600"><?= date('d F Y', $guru->date_created); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane fade show active" id="nav-profile" role="tabpanel">
                                <form action="<?= base_url('sw-guru/profile/update'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="nama_guru" class="form-control form-control-lg form-control-solid" value="<?= $guru->nama_guru; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="email" class="form-control form-control-lg form-control-solid bg-light" value="<?= $guru->email; ?>" readonly />
