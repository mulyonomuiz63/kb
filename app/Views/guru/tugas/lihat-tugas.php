                        ...
                        <div id="toggleAccordion">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" id="...">
                                    ...
                                    <section class="mb-0 mt-0">
                                        ...
                                        <div role="menu" class="collapsed" data-toggle="collapse" data-target="#defaultAccordionOne" aria-expanded="true" aria-controls="defaultAccordionOne">
                                            ...
                                            Lihat Histori Chat <div class="icons"><svg> ... </svg></div>
                                ...
                                <div class="card-footer" style="background: #fff;">
                                    ...
                                    <textarea class="form-control" name="text" placeholder="Tulis komentar / chat" aria-label="Tulis komentar / chat" rows="1" wrap="hard" required></textarea>

                                    <button id="chat_tugas" class="btn btn-primary d-flex ml-auto mt-2" type="button">Kirim Chat</button>
                                            ...
                                            <li class="list-group-item list-group-item-action">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h6 class="tx-inverse"><?= $ts->nama_siswa; ?> <?= date("d-m-Y H:i:s", ($ts->date_send)); ?></h6>
    ...
    $(document).ready(function() {
        ...
        $('#chat_tugas').click(function() {
            ...
            if (chat_tugas != '') {
                ...
                alert("Kolom chat tidak boleh kosong");
            }
        ...
        function get_chat_tugas() {
            ...
            setInterval(() => {
                ...
                const kode_tugas = "<?= $tugas->kode_tugas; ?>";
