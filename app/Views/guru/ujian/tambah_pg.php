...
<script>
    ...
    $(document).ready(function() {
        ...
        var t = $('#table').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo site_url('guru/getBankSoal') ?>",
                "type": "POST",
                data: function(d) {
        ...
        $('#table').on('click', 'tbody input#tambahSoal', function() {
            if ($(this).is(':checked')) {
                ...
                $.ajax({
                    ...
                    dataType: 'JSON',
                    async: true,
                    url: "<?= base_url('guru/tambah_bank_soal') ?>",
                    success: function(data) {
                        ...
                        pg = `
                            ...
                            <hr>
                                <div class="form-group">
                                    <label for="">Soal No . ` + no_soal + `</label>
                                    <textarea name="nama_soal[]" cols="30" rows="2" class="summernote" wrap="hard" required>` + nama_soal + `</textarea>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_1[]" value="` + pg_1 + `" class="form-control" placeholder="Opsi A" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_2[]" value="` + pg_2 + `" class="form-control" placeholder="Opsi B" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_3[]" value="` + pg_3 + `" class="form-control" placeholder="Opsi C" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_4[]" value="` + pg_4 + `" class="form-control" placeholder="Opsi D" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pg_5[]" value="` + pg_5 + `" class="form-control" placeholder="Opsi E" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="jawaban[]" value="` + jawaban + `" class="form-control" placeholder="Contoh : A" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Penjelasan</label>
                                    <textarea name="penjelasan[]" cols="30" rows="2" class="summernote" wrap="hard" required>` + penjelasan + `</textarea>
                                </div>
                                <a href="javascript:void(0);" class="btn btn-danger hapus-pg">Hapus</a>
                            </div>
                           `;
