...
<style>
    ...
    .answer-box.bg-success {
        background-color: #E8FFF3 !important;
        border-color: #50cd89 !important;
        color: #181C32;
    }

    .answer-box.bg-danger {
    ...
    .answer-box.border-success {
        border: 2px dashed #50cd89 !important;
    }
</style>
<?= $this->endSection() ?>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="row g-6">
            ...
            <div class="col-xl-3">
                <div class="card card-flush shadow-sm sticky-lg-top" style="top: 130px; z-index: 95;">
