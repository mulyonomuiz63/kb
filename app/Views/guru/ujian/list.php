                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget-heading">
                            ...
                            <a href="<?= base_url('sw-guru/ujian/create'); ?>" class="btn btn-primary mt-3">Tambah Ujian</a>
                        </div>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                                        <?php if ($u->jenis_ujian == 1) : ?>
                                                            <a class="dropdown-item" href="<?= base_url('sw-guru/ujian/lihat-essay/') . encrypt_url($u->kode_ujian); ?>">Lihat</a>
                                                        <?php else : ?>
                                                            <a class="dropdown-item" href="<?= base_url('sw-guru/ujian/lihat-ujian/') . encrypt_url($u->kode_ujian); ?>">Lihat</a>
                                                        <?php endif; ?>
                                                        <a class="dropdown-item" href="<?= base_url('sw-guru/ujian/edit-ujian/') . encrypt_url($u->kode_ujian); ?>">Edit</a>
                                                        <a class="dropdown-item" target="_blank" href="<?= base_url('sw-guru/ujian/cetak-soal/') . encrypt_url($u->kode_ujian); ?>">Cetak PDF</a>
