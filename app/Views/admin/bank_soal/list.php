            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end gap-3" data-kt-bank-soal-table-toolbar="base">
                        <a href="<?= base_url('sw-admin/kategori'); ?>" class="btn btn-light-primary fw-bold">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                <a href="<?= base_url('sw-admin/bank-soal/edit') . '/' . encrypt_url($u->id_bank_soal); ?>" class="menu-link px-3">Edit</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0)" data-url="<?= base_url('sw-admin/bank-soal/delete') . '/' . encrypt_url($u->id_bank_soal); ?>" class="menu-link px-3 btn-hapus text-danger btn-delete">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div class="modal-dialog modal-dialog-centered mw-400px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7 text-center">
                <a href="<?= base_url('sw-admin/bank-soal/create'); ?>" class="btn btn-primary me-3">Input Manual</a>
...
<div class="modal fade" id="excel_ujian" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form action="<?= base_url('sw-admin/excel_bank_soal_pg'); ?>" method="POST" enctype="multipart/form-data">
