...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form action="<?= base_url('sw-admin/guru/update-soal'); ?>" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function uploadImage(image, which_sum) {
            ...
            $.ajax({
                url: "<?= base_url('sw-admin/guru/upload-summernote') ?>",
                cache: false,
                contentType: false,
                processData: false,
                data: data,
        ...
        function deleteImage(src) {
            $.ajax({
                url: "<?= base_url('sw-admin/guru/delete-image') ?>",
                type: "POST",
                data: {
                    [csrfName]: csrfHash,
                    src: src
