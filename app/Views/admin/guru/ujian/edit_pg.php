                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            ...
                            foreach ($detail_ujian as $rows) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('sw-admin/guru/edit-soal/' . encrypt_url($rows->id_detail_ujian)); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Soal">
